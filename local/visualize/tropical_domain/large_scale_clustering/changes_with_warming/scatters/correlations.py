...
def main():
    ...
    # y_tfreq,  y_group,    y_name,     y_var,  y_label,    y_units =   'daily',    'doc_metrics',      'reference_proximity',  'reference_proximity_eq_hydro_thres_precip_prctiles_95',      r'P$_{heq}$',       r'km'   
    ...
    for model in cL.get_model_letters():
        ...
        # dn = n_warm.mean(dim = ('time'))  - n.mean(dim = ('time'))
        # print(dn)
        # exit()

        # -- for alternative normalization --
        # if model in ['NESM3', 'CNRM-ESM2-1', 'CNRM-CM6-1', 'TaiESM1']:                    # 90th percentile (Cz normalization)
        #     continue
        # if model in ['NESM3', 'CNRM-ESM2-1', 'GFDL-CM4']: #, 'CNRM-CM6-1', 'TaiESM1']:    # 95th percentile (Cz normalization)
        #     continue
        # if model in ['CNRM-CM6-1', 'NESM3', 'INM-CM5-0']:                                 # 97th percentile (Cz normalization)
        #     continue
        # if np.abs(dn.data) < 0.03:                                                        # SST gradient
        #     # print(model)
        #     # print('executes')
        #     continue
        # # # exit()
