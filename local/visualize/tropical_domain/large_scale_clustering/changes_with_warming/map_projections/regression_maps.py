...
def main():
    ...
    # x_tfreq,  x_group,    x_name,     x_var,  x_label,    x_units =   'daily',    'doc_metrics',      'reference_proximity',  'reference_proximity_meridional_line_thres_precip_prctiles_95',      r'P$_z$',       r'km'   
    ...
    # x_tfreq,  x_group,    x_name,     x_var,  x_label,    x_units =   'daily',    'doc_metrics',      'reference_proximity',  'reference_proximity_zonal_line_thres_precip_prctiles_95',      r'P$_{eq}$',       r'km'   
    ...
    # x_tfreq,  x_group,    x_name,     x_var,  x_label,    x_units =   'daily',    'doc_metrics',      'reference_proximity',  'reference_proximity_eq_hydro_thres_precip_prctiles_90',      r'C$_m$',       r'km'   
    # x_tfreq,  x_group,    x_name,     x_var,  x_label,    x_units =   'daily',    'doc_metrics',      'reference_proximity',  'reference_proximity_eq_hydro_thres_precip_prctiles_95',      r'P$_{heq}$',       r'km'   
    # x_tfreq,  x_group,    x_name,     x_var,  x_label,    x_units =   'daily',    'doc_metrics',      'reference_proximity',  'reference_proximity_eq_hydro_thres_precip_prctiles_97',      r'C$_m$',       r'km'   
    ...
    # -- y-metric --
    # y_tfreq,   y_group,   y_name,   y_var,  y_label,   y_units =  'daily',    'conv',             'conv_map',             'conv_map_mean',                            r'FOO',           r'%'      
    ...
    # y_tfreq,   y_group,   y_name,   y_var,  y_label,   y_units =  'monthly',  'clouds',           'clouds_map',           'clouds_map_high_mean',                      r'HCF',         r'%'      
    y_tfreq,   y_group,   y_name,   y_var,  y_label,   y_units =  'monthly',  'rel_humid',        'rel_humid_map',        'rel_humid_map_mean',                       r'RH$_{700hpa}$',          r'%'     
    # y_tfreq,   y_group,   y_name,   y_var,  y_label,   y_units =  'monthly',  'rel_humid_mid',    'rel_humid_map',        'rel_humid_map_mean',                       r'RH$_{500hpa}$',          r'%'     
    # y_tfreq,   y_group,   y_name,   y_var,  y_label,   y_units =  'monthly',  'rel_humid_upper',  'rel_humid_map',      'rel_humid_map_mean',                       r'RH$_{250hpa}$',          r'%'     
    ...
    text = rf'd{y_label} / d{x_label} [{y_units}{n_units}/{x_units}{n_units}]' # rf'dFOO [%]' #
