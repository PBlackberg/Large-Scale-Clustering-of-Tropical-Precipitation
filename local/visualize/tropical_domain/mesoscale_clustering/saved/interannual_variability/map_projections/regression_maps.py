...
def main():
    # == specify metric ==
    # -- x-metric --
    # x_tfreq,    x_group,    x_name, x_var,  x_label,    x_units =   'daily',        'doc_metrics',      'mean_area',            'mean_area_thres_pr_percentiles_90',                            r'A$_m$',       r'km$^2$'    
    # x_tfreq,    x_group,    x_name, x_var,  x_label,    x_units =   'daily',        'doc_metrics',      'mean_area',            'mean_area_thres_pr_percentiles_95',                            r'A$_m$',       r'km$^2$'    
    # x_tfreq,    x_group,    x_name, x_var,  x_label,    x_units =   'daily',        'doc_metrics',      'mean_area',            'mean_area_thres_pr_percentiles_97',                            r'A$_m$',       r'km$^2$'    

    # x_tfreq,    x_group,    x_name, x_var,  x_label,    x_units =   'daily',        'doc_metrics',      'area_fraction',        'area_fraction_thres_pr_percentiles_90',                        r'A$_f$',       r'km$^2$'    
    x_tfreq,    x_group,    x_name, x_var,  x_label,    x_units =   'daily',        'doc_metrics',      'area_fraction',        'area_fraction_thres_pr_percentiles_95',                        r'A$_f$',       r'km$^2$'    
    # x_tfreq,    x_group,    x_name, x_var,  x_label,    x_units =   'daily',        'doc_metrics',      'area_fraction',        'area_fraction_thres_pr_percentiles_97',                        r'A$_f$',       r'km$^2$'    

    # x_tfreq,    x_group,    x_name, x_var,  x_label,    x_units =   'daily',        'doc_metrics',      'mean_area_area_fraction',            'mean_area_thres_pr_percentiles_90_area_fraction_thres_pr_percentiles_90',   r'A$_m$|A$_f$',       r'km$^2$'    
    # x_tfreq,    x_group,    x_name, x_var,  x_label,    x_units =   'daily',        'doc_metrics',      'mean_area_area_fraction',            'mean_area_thres_pr_percentiles_95_area_fraction_thres_pr_percentiles_95',   r'A$_m$|A$_f$',       r'km$^2$'    
    # x_tfreq,    x_group,    x_name, x_var,  x_label,    x_units =   'daily',        'doc_metrics',      'mean_area_area_fraction',            'mean_area_thres_pr_percentiles_97_area_fraction_thres_pr_percentiles_97',   r'A$_m$|A$_f$',       r'km$^2$'    
    ...
    y_tfreq,   y_group,   y_name,   y_var,  y_label,   y_units =   'monthly',       'clouds',           'cloud_map',            'cloud_map',                            r'HCF',           r'%' #r'LCF',           r'%'  
    ...
    # regression_coeff = ds[f'{y_name}_correlation_vs_{x_var}_regress_-30_30'].isel(beta = 0)
    # pvalues = ds[f'{y_name}_correlation_vs_{x_var}_pvalues_-30_30'].isel(beta = 0)
...
if __name__ == '__main__':    
    # path = '/Users/cbla0002/Desktop/work/metrics/observations/GPCP/conv/conv_map_correlation/GPCP/conv_map_correlation_GPCP_daily_0-360_-30-30_128x64_1998-01_2022-12.nc'
