...
def main():
    ...
    # -- x2-metric --
    x2_tfreq,   x2_group,   x2_name,    x2_var, x2_label,   x2_units =    'daily',    'doc_metrics',      'mean_area',            'mean_area',                            r'A$_m$',       r'km$^2$'    
    ...
    # x2_tfreq,   x2_group,   x2_name,    x2_var, x2_label,   x2_units =    'daily',    'doc_metrics',      'reference_proximity',  'reference_proximity_zonal_line',       r'C$_m$',       r'km'   
    # x2_tfreq,   x2_group,   x2_name,    x2_var, x2_label,   x2_units =    'daily',    'doc_metrics',      'reference_proximity',  'reference_proximity_eq_hydro',         r'C$_{heq}$',   r'km'  
