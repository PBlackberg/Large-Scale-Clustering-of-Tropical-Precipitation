...
\textbf{1. Why does the ITCZ narrow with warming}
\noindent\emph{Comment:} \\
...
\textbf{2. Why does an El Nino like SST pattern increase clustering of heavy precipitation?}
\noindent\emph{Comment:} \\
"Contradiction with existing literature on large-scale clustering of rainfall?"
...
\textbf{3. What is the mechanism associated with the cloud feedback? - Stability?}
\noindent\emph{Comment:} \\
...
\textbf{4. What is the statistical uncertainty and robustness of the presented relationships?}
\noindent\emph{Comment:} \\
...
\textbf{5. Wording about greater / smaller in a relative sense}
\noindent\emph{Comment:} \\
...
\textbf{6. Sensitivity of conclusions to using different precipitation thresholds}
\noindent\emph{Comment:} \\
...
\textbf{7. In certain regions heating, drying, and low cloud amount show inconsistent relationships, why? }
\noindent\emph{Comment:} \\
