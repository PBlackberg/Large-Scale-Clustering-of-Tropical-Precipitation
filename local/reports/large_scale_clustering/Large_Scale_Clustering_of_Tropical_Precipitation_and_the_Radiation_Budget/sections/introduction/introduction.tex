...
is associated with clear-sky and cloud-radiative feedbacks. 
% Question
In this study we elucidate to what extent observed and modelled interannual variability in large-scale clustering of heavy precipitation connects to similar radiative feedbacks and whether such relationships can be used to constrain climate sensitivity.
% Novelty and structure of paper
To do so, we quantify and relate clustering of heavy rainfall to the tropical-mean and distribution of relative humidity and low-cloudiness 
in observations, a high-resolution GCM from the NextGEMS pre-final cycle, and GCMs from the CMIP6 ensemble (method described in Section 2).
The results of this study adds to the existing literature by describing 
the spatial patterns of heavy rainfall that promote large-scale clustering (Section 3), 
...
% == Extra ==
% connected to climate sensitivity
