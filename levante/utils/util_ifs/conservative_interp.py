...
def conservatively_interpolate(da_in, switch_res, switch_area, simulation_id, full_domain = True):
    username, SU_project, folder_scratch = mS.get_user_specs()
    ...
    # -- weights --
    x_res = switch_res["lon_res"]
    y_res = switch_res["lat_res"]
