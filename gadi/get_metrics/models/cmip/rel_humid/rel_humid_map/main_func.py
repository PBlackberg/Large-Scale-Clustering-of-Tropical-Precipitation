...
def get_metric(dataset, t_freq, lon_area, lat_area, resolution, time_period, years, months, r_folder, r_filename, section_range, test):    
    ...
    if test:                                                                                                                            # for quickly testing some timesteps
        ...
        try:
            ...
            process_request = ['hur', dataset, t_freq, resolution, time_period]                                                          # specify data request (for test)
        ...
        print('getting data ..')
        process_request = ['hur', dataset, t_freq, resolution, time_period]                                                             # specify data request
...
if __name__ == '__main__':
    ...
    # ds = xr.open_dataset('/g/data/k10/cb4968/metrics/models/cmip/conv/conv_map/ACCESS-CM2/conv_map_ACCESS-CM2_daily_0-360_-30-30_128x64_1970-01_1999-12.nc')
    # print(ds)
    # exit()
