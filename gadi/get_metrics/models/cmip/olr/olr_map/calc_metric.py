...
def calculate_metric(data_objects):
    ...
    ds[f'{metric_name}_mean_se'] = da_se.mean(dim = 'time')
    ...
    # lat: [-21.4, -18.6, -15.8, -13. , -10.2,  -7.4,  -4.6], lon: [233.8, 236.6, 239.4, 242.2, 245., 247.8, 250.6, 253.4, 256.2, 259. , 261.8, 264.6, 267.4, 270.2,] (correlated)
    # lat_min, lat_max, lon_min, lon_max = -20, -5, 235, 270                                    # east pacific ocean 
    # print(da.lat)
    # print(da.lon)
    # exit()
    # lat_min, lat_max, lon_min, lon_max = -20, -10, 240, 260   # lat: [-21.4, -18.6, -15.8, -13. , -10.2,  -7.4,  -4.6], lon: [233.8, 236.6, 239.4, 242.2, 245., 247.8, 250.6, 253.4, 256.2, 259. , 261.8, 264.6, 267.4, 270.2,] (correlated)
    # plot = False
    # if plot:
    #     folder = f'{os.path.dirname(__file__)}/plots'
    #     filename = f'olr_se_pacific.png'
    #     path = f'{folder}/{filename}'
    #     pf_M.plot(da_se.isel(time = 0), path, ds_contour = xr.Dataset({'var': da.mean(dim = 'time')}))