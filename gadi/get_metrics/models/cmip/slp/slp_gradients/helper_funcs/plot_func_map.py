...
def get_contour_settings(ds):
    ds.attrs.update({
        'threshold': ds["var"].quantile(0.10, dim=('lat', 'lon')).data,
        'color': 'k',
        'linewidth': 1,
        })
    return ds
...
# =========================================== main plot ===========================================
def plot(da, temp_path, lines = [], ds_ontop = None, ds_contour = None, title = '', lon_coords = '', lat_coords = ''):
    ...
    ax.scatter(lon_coords, lat_coords, transform=ccrs.PlateCarree(), color = 'r', s = 10)
