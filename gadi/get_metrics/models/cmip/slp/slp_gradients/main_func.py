...
def get_metric(dataset, t_freq, lon_area, lat_area, resolution, time_period, years, months, r_folder, r_filename, section_range, test):    
    ...
    if test:                                                                                                                            # for quickly testing some timesteps
        ...
        try:
            ...
            process_request = ['ps', dataset, t_freq, resolution, time_period]                                                         # specify data request (for test)
        ...
        print('getting data ..')
        process_request = ['psl', dataset, t_freq, resolution, time_period]                                                             # specify data request (ps in some datasets)
