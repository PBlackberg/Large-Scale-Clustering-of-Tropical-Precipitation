...
def main():
    ...
    n_jobs_calc_tot = 0                                                                                                             #
    last_job = len(list(itertools.product(t_freqs, lat_areas, lon_areas, resolutions, datasets, time_periods))) - 1                 # send email for this if needed
    for i, (t, lat, lon, r, d, p) in enumerate(itertools.product(t_freqs,                                                           
        ...
        walltime_calc = '2:30:00'                                                                                                   # job time for each section
